...
3. Also list any cron jobs from `.caravel/jobs/` with their name and schedule.
...
1. Read `.caravel/settings.json` and show the current prompt.
...
Location: `.caravel/settings.json`
